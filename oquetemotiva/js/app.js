(function (){
    ...
    function setBgGreet(){
        ...
        if(hour >= 5 && hour < 12){
            document.body.style.backgroundImage = "url('css/img/ceu-azul.jpg')";
            greeting.textContent = 'Bom Dia, ';
        } else if (hour >= 12 && hour < 18) {
            document.body.style.backgroundImage = "url('css/img/entardecer.jpg')";
            greeting.textContent = 'Boa Tarde, ';
        } else {
            document.body.style.backgroundImage = "url('css/img/noite.jpeg')";
